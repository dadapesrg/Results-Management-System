...
urlpatterns = [
    ...
    path('transcript/<int:id>/', views.transcript_for, name='transcript_for'),
    path('broadsheet/', views.broadsheet, name='broadsheet'),
    path('broadsheet/<int:id>/', views.broadsheet_for, name='broadsheet_for'),
    ...
    path('session/delete/<int:pk>/',
         views.session_delete_view, name="delete_session"),
    ...
    path('semester/edit/<int:pk>/',
         views.semester_update_view, name="edit_semester"),
    path('semester/delete/<int:pk>/',
         views.semester_delete_view, name="delete_semester"),
    path('result/', views.view_result, name="view_results"),
    path('password/', views.change_password, name='change_password'),
    path('course/assign/', views.CourseAllocationView.as_view(),
         name='course_allocation'),
    path('course/registration/', views.course_registration,
         name='course_registration'),
    path('course/drop/', views.course_drop, name='course_drop'),
    path('course/allocated/', views.course_allocation_view,
         name='course_allocation_view'),
    path('course/deallocate/<int:pk>/',
         views.withheld_course, name='withheld_course'),
    ...
    path('students/1st_class_list/',
         views.first_class_list, name='first_class_list'),
    path('result/print/<int:id>/', views.result_sheet_pdf_view,
         name='result_sheet_pdf_view'),
    path('result/print_excel/<int:id>/', views.result_sheet_excel_view,
         name='result_sheet_excel_view'),
    path('result/transcript/<int:id>/', views.print_transcript,
         name='print_transcript'),
    path('result/broadsheet/<int:id>/', views.print_broadsheet,
         name='print_broadsheet'),
    path('result/slip/', views.print_result, name='print_result'),
    path('registration/form/', views.course_registration_form,
         name='course_registration_form'),
